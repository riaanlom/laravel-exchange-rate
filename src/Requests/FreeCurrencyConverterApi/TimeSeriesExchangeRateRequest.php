...
use Yoelpc4\LaravelExchangeRate\Contracts\Requests\TimeSeriesExchangeRateRequest as RequestContract;

class TimeSeriesExchangeRateRequest extends Request implements RequestContract, MustValidated
{
    use Util;
