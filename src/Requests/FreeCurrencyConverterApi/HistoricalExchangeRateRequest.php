...
use Yoelpc4\LaravelExchangeRate\Contracts\Requests\HistoricalExchangeRateRequest as RequestContract;
use Yoelpc4\LaravelExchangeRate\Contracts\Requests\MustValidated;

class HistoricalExchangeRateRequest extends Request implements RequestContract, MustValidated
{
    use Util;
